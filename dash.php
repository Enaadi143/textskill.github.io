...
<?php include_once 'code/dbConnection.php'; ?>
...
echo  '<div class="panel"><div class="table-responsive overflow-auto" style="height:520px"><table class="table table-striped title1">
...
if($rowcount == 0){
	...
	<td><b><a href="check.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update_admin.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Restart</b></span></a></b></td></tr>';
}
}
$c=0;
echo '</table></div></div>';
...
echo  '<div class="panel title" ><div class="table-responsive overflow-auto"style="height:520px;">
...
echo  '<div class="panel"><div class="table-responsive" style="height:520px;"><table class="table table-striped title1">
